...
document.querySelector('#buttonLoadStorage').addEventListener('click', Modal.load.open);
document.querySelector('#buttonLoadStorageClose').addEventListener('click', Modal.load.close);
...
document.querySelector('#loadStorageForm').addEventListener('submit', Form.load.submit);
